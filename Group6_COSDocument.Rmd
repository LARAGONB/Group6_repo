...
affiliation:
  ...
  - id          : 4
    institution : Institute of Forestry and Conservation, University of Toronto, Toronto, ON M5S 3E8, Canada 
  - id          : 5
...
Where sex and class determinant for survival aboard the Titanic?

`r rmarkdown::metadata$title`

## Description

It is well known that the survivorship upon the sinking of the Titanic was heavily influenced by sex and class of the individual. Studies reveal the role of sex and class was such a strong predictor of survival due to policies and social/physical barriers put in place that prioritzied first class and women/children. However, to our knowledge, no studies have investigated the impact of other variables on survival. Therefore, using a multivariate model we will test not only for sex and class, but also effects of age, family members, ticket fare, home destination and boat number. Enter your response here.

## Hypotheses

If both sex and class affected the survival aboard the Titanic, first-class passengers and women had a higher survival rate.
...
Since this is a replication study, we have read prior papers analyzing the predictors of survival on the Titanic. The conclusions from these papers were that sex and class were the main influence on survival. However, no statistical tests were used to conclude these effects, rather they compared a table of those who survived and died. To determine the effect of class and sex, the authors also used information provided by survivors who described their experiences. We have not read any studies that statistically analyzed all determinants of survival, therefore we are unaware of any summary statistics.
...
```
This study utilized the publicly available titanic dataset found in R. The principal source for the data in this package is the Encyclopedia Titanica but a variety of researchers contributed to the datasets, including Eaton & Haas (1994) Titanic: Triumph and Tragedy, Patrick Stephens Ltd (CITATION: TitanicMETA) The study population used is not reproducible as it relied on the specific circumstances of the Titanic sinking, which we hope never happens again. Comparative analyses, however, can be performed on similar events such as the sinking of the Lusitania (Frey et al. 2010), but the exact conditions are unlikely to be repeated.
...
```
We will be using the predictor variables age, class, fare, gender, and boat ID to understand drivers of survival aboard the titanic.
...
```
To assess the drivers of survivability aboard the titanic, mixed effect models will be run with X fixed effects and Y random effects.
